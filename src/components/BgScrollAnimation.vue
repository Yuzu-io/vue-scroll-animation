...
const listItem = (el: HTMLElement):undefined => {
  items.value.push(el)
}
...
const createAnimation = (xStart: number, xEnd: number, yStart: number, yEnd: number)=> {
...
const updateAnimationMap = ()=> {
  ...
  //拿到蓝色部分的矩形区域
  const playGroundRect = (playGround.value as HTMLElement).getBoundingClientRect();
  ...
  //方块的矩形区域
  const listRect = (list.value as HTMLElement).getBoundingClientRect();
  ...
  <div ref="playGround" class="playground">
    <div class="animation-container">
      <div ref="list" class="list">
        <div :ref="listItem" data-order="0" class="list-item"></div>
        <div :ref="listItem" data-order="1" class="list-item"></div>
        <div :ref="listItem" data-order="2" class="list-item"></div>
        <div :ref="listItem" data-order="3" class="list-item"></div>
        <div :ref="listItem" data-order="2" class="list-item"></div>
        <div :ref="listItem" data-order="1" class="list-item"></div>
        <div :ref="listItem" data-order="0" class="list-item"></div>
        <div :ref="listItem" data-order="0" class="list-item"></div>
